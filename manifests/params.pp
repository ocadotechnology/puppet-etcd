...
class etcd::params {
  ...
  # Member settings
  $etcd_node_name               = $::fqdn
  $etcd_listen_peer_url         = ["http://${::fqdn}:2380", "http://${::fqdn}:7001", "http://127.0.0.1:2380", "http://127.0.0.1:7001"]
  $etcd_listen_client_url       = ["http://${::fqdn}:2379", "http://${::fqdn}:4001", "http://127.0.0.1:2379", "http://127.0.0.1:4001"]
