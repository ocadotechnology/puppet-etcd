...
class etcd (
  ...
  Integer                                         $election_timeout            = $etcd::params::etcd_election_timeout,
  Integer                                         $heartbeat_interval          = $etcd::params::etcd_heartbeat_interval,
  Integer                                         $snapshot_count              = $etcd::params::etcd_snapshot_count,
  Integer                                         $max_snapshots               = $etcd::params::etcd_max_snapshots,
  Integer                                         $max_wals                    = $etcd::params::etcd_max_wals,
